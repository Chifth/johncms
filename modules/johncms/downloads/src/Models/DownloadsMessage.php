 ...
 *
 * @method DownloadsMessage users()
 *
 */
class DownloadsMessage extends Model
{
    use MessageMutators;
     ...
     * @var string
     */
    protected $table = 'downloads_messages';
    ...
    protected static function boot(): void
    {
        ...
        static::addGlobalScope(
            ...
            static function (Builder $builder) {
                /** @var User $user */
                $user = di(User::class);
                if (! $user?->hasPermission(DownloadsPermissions::MANAGE_POSTS)) {
    ...
    {
        return $this->hasOne(DownloadsTopic::class, 'id', 'topic_id');
    }
    ...
    {
        return $this->hasMany(DownloadsFile::class, 'post', 'id');
    }
