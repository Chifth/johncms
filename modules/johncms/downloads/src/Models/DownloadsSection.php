 ...
 * @property DownloadsSection $subsections - Subsections
 * @property DownloadsTopic $topics        - Topics
 * @property DownloadsFile $category_files - Files of category
 * @property DownloadsFile $section_files  - Files of section
 * @property int $category_files_count - Count files of category
 * @property int $section_files_count  - Count files of section
 */
class DownloadsSection extends Model
{
    use SectionMutators;
     ...
     * @var string
     */
    protected $table = 'downloads_sections';
